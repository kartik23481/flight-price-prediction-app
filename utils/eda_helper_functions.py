...
# new num_bivariateplot
def new_num_bivar_plots(data, var_x, var_y, figsize=(12, 4.5), scatter_kwargs=None, hexbin_kwargs=None):
    if scatter_kwargs is None:
        scatter_kwargs = {}
    if hexbin_kwargs is None:
        hexbin_kwargs = {}
        
    display(HTML(f"<h3>Bi-variate Analysis between {var_x} and {var_y}</h3>"))
    ...
    # Colorbar
    cb = fig.colorbar(hexbin, ax=axes[1], label="Count")
